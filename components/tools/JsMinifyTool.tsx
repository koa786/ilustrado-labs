...
export function JsMinifyTool() {
  ...
  const minify = () => {
    ...
    // Note: This is a simple version, not a full parser like Terser
    ...
    <div className="space-y-6">
      ...
      <div className="flex gap-2">
        <Button onClick={minify} className="flex-grow">
          <Zap size={16} className="mr-2" /> Minify JS
        </Button>
      ...
      {output && (
        <div className="space-y-2">
          <div className="flex justify-between items-center">
            <label className="text-sm font-medium text-muted">Minified JS</label>
